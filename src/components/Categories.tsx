  ...
  return (
    <section className="py-8 sm:py-12 lg:py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12">Product Categories</h2>
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6 lg:gap-8">
          {categories.map((category) => (
            <div key={category.name} className="bg-[#D3D3D3] rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="p-2 sm:p-4">
                <h3 className="text-sm sm:text-base font-semibold text-center">{category.name}</h3>
              </div>
            </div>
          ))}
        </div>
